Write-Host "Generating snapshot..." -ForegroundColor Cyan
Write-Host ("Project Type: " + $projectType) -ForegroundColor Yellow
Write-Host ("Snapshot created: " + $outputFile) -ForegroundColor Green
